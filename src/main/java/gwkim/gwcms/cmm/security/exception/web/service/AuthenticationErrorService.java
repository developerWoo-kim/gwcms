package gwkim.gwcms.cmm.security.exception.web.service;

import gwkim.gwcms.cmm.security.exception.AuthenticationExceptionTypes;
import gwkim.gwcms.cmm.security.exception.AuthenticationMessageProvider;
...
public class AuthenticationErrorService {
    ...
    public String getErrorMessageByAuthenticationException(AuthenticationException exception, String memberId) {
        ...
        switch (exceptionTypes){
            ...
            case AuthorAdminNotFoundException:
            case NoneException:
