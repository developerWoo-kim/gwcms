			...
			<div class="container">
				<ul class="visual" id="m_visual">
					<c:if test="${empty mainImgList}">
						<li><img src="/images/template/01001/main/M_visual1.png" alt="스마트1"></li>
						<li><img src="/images/template/01001/main/M_visual2.png" alt="스마트2"></li>
					</c:if>
					<c:if test="${!empty mainImgList}">
...
$(document).on('click', '#nextPop', function() {
	...
	if (curPop == popLength) {
		...
		$(".now").text((parseInt(curPop)+1));
					...
					<c:otherwise>
						<ul class="pop_img">
							<li class="on"><a href="#" title="새창"><img src="/images/template/01001/main/2001_v_popup2_img_1.png" alt="홈페이지를 새롭게 리뉴얼 하였습니다. 자세히보기"></a></li>
							<li><a href="#" title="새창"><img src="/images/template/01001/main/2001_v_popup2_img_1.png" alt="홈페이지를 새롭게 리뉴얼 하였습니다. 자세히보기"></a></li>
						</ul>
						<p class="nss_pg">
			...
			<div class="M_link2001">
				<ul>
					<li class="link_01">
						<a href="#">
							<span>
								<img src="/images/template/01001/main/2001_link1_1.png" alt="스마트학습">
								<em>스마트학습</em>
							</span>
				    	</a>
			    	</li>
				    <li class="link_02">
				    	<a href="#">
				    		<span>
				    			<img src="/images/template/01001/main/2001_link1_2.png" alt="스마트펜">
				    			<em>스마트펜</em>
				    		</span>
				    	</a>
				    </li>
				    <li class="link_03">
						<a href="#">
							<span>
								<img src="/images/template/01001/main/2001_link1_3.png" alt="아이에듀란?">
								<em>아이에듀란?</em>
							</span>
						</a>
					</li>
				    <li class="link_04">
					    <a href="#">
						    <span>
							    <img src="/images/template/01001/main/2001_link1_4.png" alt="과목전체보기">
							    <em>수업신청하기</em>
						    </span>
					    </a>
				    </li>
		...
		<div class="container gallery2001 MainPhoto" id="MainPhoto">
			...
			<div class="list_box">
				<ul class="nttlist gall_list">
					<li><a href="#">
						<p class="img"><img src="/images/template/01001/main/2001_thumb_01.jpg" alt=""></p>
						<p class="txt">스마트 태블릿 강의</p>
					</a></li>
					<li><a href="#">
						<p class="img"><img src="/images/template/01001/main/2001_thumb_02.jpg" alt=""></p>
						<p class="txt">영어가 크는나무</p>
					</a></li>
					<li><a href="#">
						<p class="img"><img src="/images/template/01001/main/2001_thumb_03.jpg" alt=""></p>
						<p class="txt">5월 무료체험</p>
					</a></li>
					<li><a href="#">
						<p class="img"><img src="/images/template/01001/main/2001_thumb_04.jpg" alt=""></p>
...
<div class="banner_zone">
	<div class="container">
		...
		<ul>
			<li><a href="#"><img src="/images/template/01001/main/ban_01.gif" alt=""></a></li>
			<li><a href="#"><img src="/images/template/01001/main/ban_02.gif" alt=""></a></li>
			<li><a href="#"><img src="/images/template/01001/main/ban_03.gif" alt=""></a></li>
			<li><a href="#"><img src="/images/template/01001/main/ban_04.gif" alt=""></a></li>
			<li><a href="#"><img src="/images/template/01001/main/ban_05.gif" alt=""></a></li>
		</ul>
	</div>
</div>
// 배너존 -->
