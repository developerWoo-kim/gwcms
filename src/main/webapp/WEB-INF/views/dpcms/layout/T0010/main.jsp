				...
				<div class="MC_box1 widgEdit" data-id="10" data-ty="MAINIMG">
					...
					<div class="MVisual0010 visual">
			            ...
			            <c:if test="${empty mainImgList}">
							<p class="item"><img src="/images/web/T0010/main/m_visual.png" alt="함께 배우고 꿈꾸는 어린이!!"></p>
							<p class="item"><img src="/images/web/T0010/main/m_visual.png" alt="함께 배우고 꿈꾸는 어린이!!"></p>
						</c:if>
						<c:if test="${!empty mainImgList}">
			...
			<div class="MC_box3 widgEdit" data-id="20" data-ty="BANNER" data-tab="6">
				...
				<div class="M_link0010">
					<ul>
						<li>
							<a href="">
								<div class="img"><img src="/images/web/T0010/main/0010_link01_01.png" alt=""></div>
								<p>교육목표</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/web/T0010/main/0010_link01_02.png" alt=""></div>
								<p>유치원알리미</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/web/T0010/main/0010_link01_03.png" alt=""></div>
								<p>통학버스</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/web/T0010/main/0010_link01_04.png" alt=""></div>
								<p>사이버도서관사이버도서관사이버도서관</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/web/T0010/main/0010_link01_05.png" alt=""></div>
								<p>정보공개</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/web/T0010/main/0010_link01_06.png" alt=""></div>
								<p>학습자료실</p>
							</a>
						</li>
					</ul>
			...
			<div class="con_wrap">
				<div class="MC_box4 widgEdit" data-id="50" data-ty="POPUP">
					...
					<div class="pop0010 popupZone">
						...
						<div class="pop_img" id="popupSlide">
							...
							<c:if test="${empty popZoneList}">
								<p class="item"><a href="" title="새창" target="_blank"><img src="/images/web/T0010/main/img_popup01.png" alt="홈페이지 방문을 환영합니다."></a></p>
								<p class="item"><a href="" title="새창" target="_blank"><img src="/images/web/T0010/main/img_popup01.png" alt="홈페이지 방문을 환영합니다."></a></p>
							</c:if>
						</div>
				...
				<div class="MC_box5 widgEdit" data-id="70" data-ty="DIET">
					...
					<div class="meal_menu0010">
						...
						<img src="/images/web/T0010/main/0010_ico_meal.png" alt="">
				...
				<div class="bnWrap" id="bnSlider">
		            <c:choose>
						<c:when test="${empty bannList}">
							<p class="item"><a href="" target="_blank" title="새창이동"><img src="/images/web/T0010/main/ban_01.gif" alt="교육기부 바로가기"></a></p>
							<p class="item"><a href="" target="_blank" title="새창이동"><img src="/images/web/T0010/main/ban_02.gif" alt="온라인행정심판 바로가기"></a></p>
							<p class="item"><a href="" target="_blank" title="새창이동"><img src="/images/web/T0010/main/ban_03.gif" alt="사랑티켓 바로가기"></a></p>
							<p class="item"><a href="" target="_blank" title="새창이동"><img src="/images/web/T0010/main/ban_04.gif" alt="학부모On누리 바로가기"></a></p>
							<p class="item"><a href="" target="_blank" title="새창이동"><img src="/images/web/T0010/main/ban_05.gif" alt="EBSi 바로가기"></a></p>
							<p class="item"><a href="" target="_blank" title="새창이동"><img src="/images/web/T0010/main/ban_03.gif" alt="사랑티켓 바로가기"></a></p>
						</c:when>
						<c:otherwise>
