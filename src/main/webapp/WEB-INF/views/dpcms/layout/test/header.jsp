...
<div class="area_header">
  ...
  <header id="header"> 
    ...
    <div id="web" class="container">
      <div class="top">
       	<h1><a href="/${ctx }/main.do">
     		<!--Logo START-->
       		<img src="/images/web/test/common/logo.png" alt="KLIC 케이엘정보통신">
     		<!--Logo END-->
       	</a></h1>
        <ul class="top_menu">
    ...
    <div id="tablet">
      ...
      <div id="tabletGnb">
        <div id="menuOpen"><a href="#"><img src="/images/web/test/common/btn_menu_t.png" alt="메뉴열기"></a></div>
      </div>
      <!-- 태블릿 검색 -->
      <%-- <div id="tabletSearch">
        <div id="searchOpen"><a href="#"><img src="/images/web/test/common/btn_search_t.png" alt="검색열기"></a></div>
      </div>
      <div id="mSearch">
      ...
      <div id="mNavi">
        ...
        <nav id="mgnb">
          <div class="snb">
            <ul>
				<%-- 모바일 로그인 공통 폼 --%>
<%--				<c:import url="/WEB-INF/jsp/nfu/la/common/mLoginForm.jsp"/>--%>
            </ul>
          </div>
          <!--M_START-->
          <ul>
