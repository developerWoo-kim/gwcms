...
/*! 탑 버튼  */
!function(n){"use strict";n(document).ready(function(){n(document).trigger("nifty.ready")})}(jQuery),
!function(n){"use strict";n(document).one("nifty.ready",function(){var a=n(".scroll-top"),e=n(window),t=function(){return/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)}();if(a.length&&!t){var i=!1,o=100,s=function(){e.scrollTop()>o&&!i?(a.addClass("in").stop(!0,!0).css({animation:"none"}).show(0).css({animation:"jellyIn .8s"}),i=!0):e.scrollTop()<o&&i&&(a.removeClass("in"),i=!1)};s(),e.scroll(s),a.on("click",function(a){a.preventDefault(),n("body, html").animate({scrollTop:0},500)})}else a=null,e=null;t=null})}(jQuery)
