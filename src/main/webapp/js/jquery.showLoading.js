jQuery.fn.showLoading=function(options){
	...
	if(settings.divId){
		...
		loadingDiv=jQuery('<div style="width:180px;height:70px;background-color:#FFFFFF;border:1px solid #CFCFCF;text-align:center;"><div style="padding-top:17px;"><img id="loadImg" src=""/></div><div style="padding-top:10px;font-weight:bold">'+loadMsg+'</div></div>');
