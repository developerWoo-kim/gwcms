$(function() {
	...
	//gallery visual
	var popupPrev = '.galleryZone .prev';
	var popupNext = '.galleryZone .next';
	var popupStop = '.galleryZone .stop';
	var popupPlay = '.galleryZone .play';
	$("#gallerySlide").slick({
		slider: '.item',
		infinite: true,
		autoplaySpeed: 4000,
	...
	$('.galleryZone .control a').click(function(e){
		slickControl($(this), '#gallerySlide', popupStop, popupPlay);
		e.preventDefault();
	});
