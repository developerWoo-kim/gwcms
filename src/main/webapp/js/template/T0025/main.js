$(function() {
	...
	// link01 hover active
	$(".M_link0011 li a").each(function(){
		$(this).hover(function () {
			$(this).find(".img img").attr("src", $(this).find(".img img").attr("src").replace(".png", "_active.png"));
		}, function () {
			$(this).find(".img img").attr("src", $(this).find(".img img").attr("src").replace("_active.png", ".png"));
		});
	}); 
