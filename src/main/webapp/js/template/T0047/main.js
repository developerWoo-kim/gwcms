$(function() {
	...
	//캘린더
	$(".pop_schedule0007 .sche_table table thead th:first-of-type").addClass("first");
	$(".pop_schedule0007 .sche_table table thead th:last-of-type").addClass("last");
	$(".pop_schedule0007 .sche_table table tbody tr td:first-of-type").addClass("first");
	$(".pop_schedule0007 .sche_table table tbody tr td:last-of-type").addClass("last");
