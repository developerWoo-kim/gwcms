...
<c:set var="templateType" value="T0001" />
...
<div id="wrap" class="openPop"> <!--[D] 팝업이 있을때 #wrap에 클래스 openPop 추가-->
	...
	<div id="container">
		...
		<div class="MC_wrap1">
			...
			<div class="MC_box2">
				<!-- 바로가기1 -->
				<div class="M_link0001">
					<ul>
						<li class="col1"><a href="">
							<img src="/images/template/${templateType}/main/0001_link01_1.png" alt="">
							<p>교육과정 교육과정 교육과정</p>
						</a></li>
						<li class="col2"><a href="">
							<img src="/images/template/${templateType}/main/0001_link01_2.png" alt="">
							<p>학습과정</p>
						</a></li>
						<li class="col3"><a href="">
							<img src="/images/template/${templateType}/main/0001_link01_3.png" alt="">
							<p>운영위원회</p>
						</a></li>
						<li class="col4"><a href="">
							<img src="/images/template/${templateType}/main/0001_link01_4.png" alt="">
							<p>유치원알리미</p>
						</a></li>
					</ul>
				</div>
		...
		<div class="MC_wrap2 container">
				...
				<div class="notice0001">
					...
					<div class="tabWrap">
						...
						<div class="list_box" id="notice2">
							...
							<a href="" class="btn_more ty"><span class="hid">가정통신문 더보기</span><i class="xi-plus" aria-hidden="true"></i></a>
						</div>
						<div class="list_box" id="notice3">
							...
							<a href="" class="btn_more ty"><span class="hid">게시판 더보기</span><i class="xi-plus" aria-hidden="true"></i></a>
						</div>
					</div>
				</div>
				<!-- //게시판 -->
			...
			<div class="MC_box6">
				...
				<div class="meal_menu0001">
					...
					<img src="/images/template/${templateType}/main/0001_img_meal.png" alt="">
		...
		<div class="MC_wrap3">
			<div class="MC_box7">
				<!-- 갤러리 -->
				<div class="gallery0001">
					<h2 class="heading">포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리</h2>
					<div class="list_box">
						<ul>
							<li><a href="">
								<p class="img"><img src="/images/template/${templateType}/main/0001_thumb_01.png" alt=""></p>
								<p class="txt">
							...
							<li><a href="">
								<p class="img"><img src="/images/template/${templateType}/main/0001_thumb_02.png" alt=""></p>
								<p class="txt">
									창의력을 높이는 블럭놀이
									<span>22-01-14</span>
								</p>
							...
							<li class="pt"><a href="">
								<p class="img"><img src="/images/template/${templateType}/main/0001_thumb_03.png" alt=""></p>
								<p class="txt">
									창의력을 높이는 블럭놀이
									<span>22-01-14</span>
								</p>
