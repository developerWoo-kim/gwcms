...
<c:set var="templateType" value="T0006" />
	...
	<div id="container">
					...
					<div class="notice0006">
						...
						<div class="tabWrap">
							<div class="list_box on" id="notice1">
								...
								<a href="" class="btn_more2"><i class="xi-plus" aria-hidden="true"></i>더보기</a> 
							</div>
		...
		<div class="MC_wrap3">
			<div class="container">
				<div class="MC_box5">
					<!-- 바로가기1 -->
					<div class="M_link0006">
						<ul>
							<li>
								<a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0006_link01_01.png" alt=""></p>
									<p class="tit"><span>교육목표</span></p>
								</a>
							</li>
							<li>
								<a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0006_link01_02.png" alt=""></p>
									<p class="tit"><span>유치원알리미</span></p>
								</a>
							</li>
							<li>
								<a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0006_link01_03.png" alt=""></p>
									<p class="tit"><span>통학버스</span></p>
								</a>
							</li>
							<li>
								<a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0006_link01_04.png" alt=""></p>
									<p class="tit"><span>사이버도서관</span></p>
								</a>
							</li>
							<li>
								<a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0006_link01_05.png" alt=""></p>
									<p class="tit"><span>정보공개</span></p>
								</a>
							</li>
						</ul>
					</div>
				...
				<div class="con_wrap">
					<div class="MC_box6">						
						<!-- 식단 -->
						<div class="meal_menu0006">
							<div class="tit_wrap">
								<h2>오늘의 식단</h2>
								<img src="/images/template/${templateType}/main/0006_img_meal.png" alt="">
							</div>
							<div class="inner">
								<ul tabindex="0">
									<li>
						...
						<div class="gallery0006">
							...
							<div class="list_box">
								<ul>
									<li>
										<a href="">
											<p class="img"><img src="/images/template/T0006/main/0006_thumb_01.png" alt=""></p>
											<span>창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이</span>
										</a>
									</li>
									<li>
										<a href="">
											<p class="img"><img src="/images/template/T0006/main/0006_thumb_02.png" alt=""></p>
											<span>교외 현장 체험학습</span>
										</a>
									</li>
									<li>
										<a href="">
											<p class="img"><img src="/images/template/T0006/main/0006_thumb_03.png" alt=""></p>
											<span>영어로 놀이하기 방과후활동</span>
										</a>
									</li>
									<li>
										<a href="">
											<p class="img"><img src="/images/template/T0006/main/0006_thumb_04.png" alt=""></p>
											<span>창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이</span>
										</a>
									</li>
									<!-- 데이터가 없는경우 아래의 내용만 출력해주세요! -->
