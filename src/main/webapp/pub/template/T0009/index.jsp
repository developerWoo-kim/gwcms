...
<c:set var="templateType" value="T0009" />
	...
	<div id="container">				
		...
		<div class="MC_wrap1">
			<div class="container">
					...
					<div class="notice0009">
						...
						<div class="tabWrap">
							<div class="list_box on" id="notice1">
								<a href="" class="topList">
									<dl class="new"><!-- 새글 dl 'new' class 추가-->
										...
										<dd>
											...
											<span class="date">03 <em>0222.02</em></span>
										</dd>
									</dl>
								...
								<a href="" class="btn_more btnTy1"><span>더보기</span><i class="xi-plus" aria-hidden="true"></i></a> 
							</div>
							<div class="list_box" id="notice2">
								<!-- 데이터가 없을 시, dl 'no_data' class 추가-->
								<dl class="no_data">
									<dt>데이터가 없습니다</dt>
									<dd><div class="date no_data"><p> - </p></div></dd>
								</dl>
								<a href="" class="btn_more btnTy1"><span>더보기</span><i class="xi-plus" aria-hidden="true"></i></a> 
							</div>
				...
				<div class="MC_box3">	
					<!-- 팝업존 -->
					<div class="pop0009 popupZone">
						<div class="tit_wrap">
							<h2 class="heading">팝업존</h2>
							<div class="control arwShow">
								<p class="page"><strong>1</strong><span>3</span></p>
								<a href="" class="prev"><span class="hid">팝업존 이전</span><img src="/images/template/T0009/main/0009_btn_prev.png" alt=""></a>
								<a href="" class="stop"><span class="hid">팝업존 정지</span><img src="/images/template/T0009/main/0009_btn_stop.png" alt=""></a>
								<a href="" class="play"><span class="hid">팝업존 재생</span><i class="xi-play" aria-hidden="true"></i></a>
								<a href="" class="next"><span class="hid">팝업존 다음</span><img src="/images/template/T0009/main/0009_btn_next.png" alt=""></a>
							</div>
						</div>
				...
				<div class="MC_box4">		
					<!-- 갤러리 -->
					<div class="gallery0009">
						<h2 class="heading">포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리</h2>
						<div class="list_box">
							<ul>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0009_thumb_01.png" alt=""></p>
									<span>창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이</span>
								</a></li>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0009_thumb_02.png" alt=""></p>
									<span>교외 현장 체험학습</span>
								</a></li>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0009_thumb_03.png" alt=""></p>
				...
				<div class="MC_box5">
					<!-- 캘린더 -->
					<div class="pop_schedule0009">
						<h2 class="heading">행사일정</h2>
						<div class="sche_wrap">
							<p class="month">
								<a href="" class="prev"><span class="hid">이전달</span><img src="/images/template/T0009/main/0009_btn_prev.png" alt=""></a>
								<span>2022. <em>02</em></span>
								<a href="" class="next"><span class="hid">다음달</span><img src="/images/template/T0009/main/0009_btn_next.png" alt=""></a>
							</p>
							<div class="lst">
								<ul>
			...
			<div class="container">
				<div class="MC_box6">				
					...
					<div class="meal_menu0009">
						...
						<img src="/images/template/${templateType}/main/0009_img_meal.png" alt="">
						<a href="" class="btn_more btnTy2"><span class="hid">오늘의 식단</span><i class="xi-plus" aria-hidden="true"></i></a> 
					</div>
					<!-- //식단 -->
				</div>
				...
				<div class="MC_box7">
					...
					<div class="M_link0009">
						<ul>
							<li><a href="">
								<p><img src="/images/template/${templateType}/main/0009_link01_1.png" alt=""></p>
								<span>교육목표 교육목표 교육목표</span>
							</a></li>
							<li><a href="">
								<p><img src="/images/template/${templateType}/main/0009_link01_2.png" alt=""></p>
								<span>학습자료</span>
							</a></li>
							<li><a href="">
								<p><img src="/images/template/${templateType}/main/0009_link01_3.png" alt=""></p>
								<span>운영위원회</span>
							</a></li>
							<li><a href="">
								<p><img src="/images/template/${templateType}/main/0009_link01_4.png" alt=""></p>
								<span>유치원알리미</span>
							</a></li>
							<li><a href="">
								<p><img src="/images/template/${templateType}/main/0009_link01_5.png" alt=""></p>
								<span>사이버도서관</span>
							</a></li>
							<li><a href="">
								<p><img src="/images/template/${templateType}/main/0009_link01_6.png" alt=""></p>
								<span>차량안내</span>
							</a></li>
							<li><a href="">
								<p><img src="/images/template/${templateType}/main/0009_link01_7.png" alt=""></p>
								<span>정보공개</span>
							</a></li>
						</ul>
					</div>
