...
<c:set var="templateType" value="T0010" />
			...
			<div class="MC_box3">						
				...
				<div class="M_link0010">
					<ul>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0010_link01_01.png" alt=""></div>
								<p>교육목표</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0010_link01_02.png" alt=""></div>
								<p>유치원알리미</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0010_link01_03.png" alt=""></div>
								<p>통학버스</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0010_link01_04.png" alt=""></div>
								<p>사이버도서관사이버도서관사이버도서관</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0010_link01_05.png" alt=""></div>
								<p>정보공개</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0010_link01_06.png" alt=""></div>
								<p>학습자료실</p>
							</a>
						</li>
					</ul>
			...
			<div class="con_wrap">
				...
				<div class="MC_box5">
					...
					<div class="meal_menu0010">
						...
						<img src="/images/template/${templateType}/main/0010_ico_meal.png" alt="">
				...
				<div class="gallery0010">
					...
					<div class="list_box">
						<ul>
							<li>
								<a href="">
									<p class="img"><img src="/images/template/T0010/main/0010_thumb_01.png" alt=""></p>
									<span>창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이</span>
								</a>
							</li>
							<li>
								<a href="">
									<p class="img"><img src="/images/template/T0010/main/0010_thumb_02.png" alt=""></p>
									<span>교외 현장 체험학습</span>
								</a>
							</li>
							<li>
								<a href="">
									<p class="img"><img src="/images/template/T0010/main/0010_thumb_03.png" alt=""></p>
									<span>영어로 놀이하기 방과후활동</span>
								</a>
							</li>
							<li>
								<a href="">
									<p class="img"><img src="/images/template/T0010/main/0010_thumb_04.png" alt=""></p>
									<span>창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이</span>
								</a>
							</li>
							<!-- 데이터가 없는경우 아래의 내용만 출력해주세요! -->
					...
					<a href="" class="btn_more2"><span class="hid">포토갤러리 더보기</span></a> 
				</div>
				<!-- //갤러리 -->
			</div>
		</div>
