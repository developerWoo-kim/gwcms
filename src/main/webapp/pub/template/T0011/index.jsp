...
<c:set var="templateType" value="T0011" />
...
<div id="wrap" class="openPop"> <!--[D] 팝업이 있을때 #wrap에 클래스 openPop 추가-->
	...
	<div id="container">
		...
		<div class="MC_wrap2 container">
			<div class="MC_box2">						
				<!-- 바로가기1 -->
				<div class="M_link0011">
					<ul>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0011_link01_01.png" alt=""></div>
								<p>교육목표</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0011_link01_02.png" alt=""></div>
								<p>유치원알리미</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0011_link01_03.png" alt=""></div>
								<p>통학버스</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0011_link01_04.png" alt=""></div>
								<p>사이버도서관사이버도서관사이버도서관</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0011_link01_05.png" alt=""></div>
								<p>정보공개</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0011_link01_06.png" alt=""></div>
								<p>학습자료실</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0011_link01_07.png" alt=""></div>
								<p>정보공개</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0011_link01_08.png" alt=""></div>
								<p>학습자료실</p>
							</a>
						</li>
					</ul>
			...
			<div class="MC_box5">		
				<!-- 캘린더 -->
				<div class="pop_schedule0011">
					<div class="tit_wrap">
						<h2>행사일정</h2>
					</div>
					<div class="sche_wrap">
						<p class="month">
							<span>2022년<em>02월</em></span>
					...
					<a href="" class="btn_more"><em class="hid">행사일정 더보기</em><i class="xi-plus"></i></a> 
				</div>
				<!-- //캘린더 -->
			</div>
			<div class="MC_box6">
				<!-- 식단 -->
				<div class="meal_menu0011">
					<div class="tit_wrap">
						<h2>오늘의 식단</h2>
					</div>
					<div class="inner">
						<div class="inner_scroll">
							<ul tabindex="0">
								<li>
									<dl>
										<dt class="kcal"><span>점심 <em>984</em><span>Kcal</span></span></dt>
										<dd class="meal_list">홍국쌀밥, 쇠고기미역국, 새송이호박볶음, 달걀야채말이, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기 </dd>
									</dl>
								</li>
								<li>
									<dl>
										<dt class="kcal"><span>저녁 <em>684</em><span>Kcal</span></span></dt>
										<dd class="meal_list">홍국쌀밥, 쇠고기미역국, 새송이호박볶음, 달걀야채말이, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기 </dd>
									</dl>
								</li>
					...
					<img src="/images/template/${templateType}/main/0011_ico_meal.png" alt="">
					<a href="" class="btn_more"><em class="hid">오늘의 식단 더보기</em><i class="xi-plus"></i></a> 
				</div>
				<!-- //식단 -->
			</div>
		...
		<div class="MC_wrap3">
			<div class="container">
				<div class="MC_box7">
					<!-- 갤러리 -->
					<div class="gallery0011">
						<div class="tit_wrap">
							<h2>PHOTO GALLERY</h2>
							<p>소중한 우리들의 추억을 함께 공유합니다.</p>
						</div>
						<div class="list_box">
							<ul>
								<li>
									<a href="">
										<p class="img"><img src="/images/template/T0011/main/0011_thumb_01.png" alt=""></p>
										<span>창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이</span>
									</a>
								</li>
								<li>
									<a href="">
										<p class="img"><img src="/images/template/T0011/main/0011_thumb_02.png" alt=""></p>
										<span>교외 현장 체험학습</span>
									</a>
								</li>
								<li>
									<a href="">
										<p class="img"><img src="/images/template/T0011/main/0011_thumb_03.png" alt=""></p>
										<span>영어로 놀이하기 방과후활동</span>
									</a>
								</li>
								<li>
									<a href="">
										<p class="img"><img src="/images/template/T0011/main/0011_thumb_04.png" alt=""></p>
										<span>창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이</span>
									</a>
								</li>
