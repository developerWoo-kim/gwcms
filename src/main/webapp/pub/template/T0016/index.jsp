...
<c:set var="templateType" value="T0016" />
...
<div id="wrap" class="openPop"> <!--[D] 팝업이 있을때 #wrap에 클래스 openPop 추가-->
	...
	<div id="container">
		...
		<div class="MC_wrap2 container">
            <div class="MC_box3">
				<!-- 바로가기1 -->
				<div class="M_link0016">
					<ul>
						<li class="col1"><a href="">
                            <div class="img">
                                <img src="/images/template/${templateType}/main/0016_link01_1.png" alt="">
                            </div>
							<p>교육과정 교육과정 교육과정</p>
						</a></li>
						<li class="col2"><a href="">
                            <div class="img">
							    <img src="/images/template/${templateType}/main/0016_link01_2.png" alt="">
                            </div>
							<p>학습과정</p>
						</a></li>
						<li class="col3"><a href="">
                            <div class="img">
							    <img src="/images/template/${templateType}/main/0016_link01_3.png" alt="">
                            </div>
							<p>운영위원회</p>
						</a></li>
						<li class="col4"><a href="">
                            <div class="img">
							    <img src="/images/template/${templateType}/main/0016_link01_4.png" alt="">
                            </div>
							<p>유치원알리미</p>
						</a></li>
                        <li class="col4"><a href="">
                            <div class="img">
							    <img src="/images/template/${templateType}/main/0016_link01_5.png" alt="">
                            </div>
							<p>학부모서비스</p>
						</a></li>
                        <li class="col4"><a href="">
                            <div class="img">
							    <img src="/images/template/${templateType}/main/0016_link01_6.png" alt="">
                            </div>
							<p>정보공개</p>
						</a></li>
					</ul>
				...
				<div class="notice0016">
                    ...
                    <div class="tabWrap">
                        <div class="list_box on" id="notice1">
                            ...
                            <a href="" class="btn_more"><em class="hid">공지사항 더보기</em><i class="xi-ellipsis-h" aria-hidden="true"></i></a> 
                        </div>
                        ...
                        <div class="list_box" id="notice2">
                            ...
                            <a href="" class="btn_more"><em class="hid">자유게시판 더보기</em><i class="xi-ellipsis-h" aria-hidden="true"></i></a> 
                        </div>
            ...
            <div class="MC_box5">
                ...
                <div class="gallery0016">
                    ...
                    <div class="list_box">
                        <ul>
                            <li><a href="">
                                <p class="img"><img src="/images/template/${templateType}/main/0016_thumb_01.png" alt=""></p>
                                <div class="txt">
                                    <p>로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육</p>
                                    <span>AI로봇과 함께하는 스마트 교육을 실시AI로봇과 함께하는 스마트 교육을 실시AI로봇과 함께하는 스마트 교육을 실시AI로봇과 함께하는 스마트 교육을 실시</span>
                                    <em>22-01-14</em>
                                </div>
                            </a></li>
                            <li><a href="">
                                <p class="img"><img src="/images/template/${templateType}/main/0016_thumb_02.png" alt=""></p>
                                <div class="txt">
                                    <p>로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육</p>
                                    <span>AI로봇과 함께하는 스마트 교육을 실시AI로봇과 함께하는 스마트 교육을 실시AI로봇과 함께하는 스마트 교육을 실시AI로봇과 함께하는 스마트 교육을 실시</span>
                                    <em>22-01-14</em>
                    ...
                    <a href="" class="btn_more" title="포토갤러리 더보기"><i class="xi-ellipsis-h" aria-hidden="true"></i></a>
                </div>
                <!-- //갤러리 -->
            </div>
			<div class="MC_box6">
				<!-- 캘린더 -->
				<div class="pop_schedule0016">
                    <div class="tit_wrap">
			...
			<div class="MC_box7">						
				<!-- 식단 -->
				<div class="meal_menu0016">
					<div class="tit_wrap">
                        <img src="/images/template/T0016/main/0016_img_meal.png" alt="식단 아이콘">
