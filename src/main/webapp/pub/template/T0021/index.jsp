...
<c:set var="templateType" value="T0021" />
					...
					<div class="MC_box3">						
						...
						<div class="M_link0021">
							<ul>
								<li>
									<a href="">
										<div class="img"><img src="/images/template/${templateType}/main/0021_link01_01.png" alt=""></div>
										<p>교육목표</p>
									</a>
								</li>
								<li>
									<a href="">
										<div class="img"><img src="/images/template/${templateType}/main/0021_link01_02.png" alt=""></div>
										<p>유치원알리미</p>
									</a>
								</li>
								<li>
									<a href="">
										<div class="img"><img src="/images/template/${templateType}/main/0021_link01_03.png" alt=""></div>
										<p>통학버스</p>
									</a>
								</li>
								<li>
									<a href="">
										<div class="img"><img src="/images/template/${templateType}/main/0021_link01_04.png" alt=""></div>
										<p>사이버도서관사이버도서관사이버도서관</p>
									</a>
								</li>
								<li>
									<a href="">
										<div class="img"><img src="/images/template/${templateType}/main/0021_link01_05.png" alt=""></div>
										<p>정보공개</p>
									</a>
								</li>
								<li>
									<a href="">
										<div class="img"><img src="/images/template/${templateType}/main/0021_link01_06.png" alt=""></div>
										<p>학습자료실</p>
									</a>
								</li>
								<li>
									<a href="">
										<div class="img"><img src="/images/template/${templateType}/main/0021_link01_07.png" alt=""></div>
										<p>정보공개</p>
									</a>
								</li>
								<li>
									<a href="">
										<div class="img"><img src="/images/template/${templateType}/main/0021_link01_08.png" alt=""></div>
										<p>학습자료실</p>
									</a>
								</li>
							</ul>
				...
				<div class="gallery0021">
					...
					<div class="list_box">
						<ul>
							...
							<li>
								<a href="">
									<p class="img"><img src="/images/template/T0021/main/0021_thumb_01.png" alt=""></p>
									<div class="tit">
			...
			<div class="con_wrap">
					...
					<div class="pop0021 popupZone">
						<div class="tit_wrap">
							...
							<div class="control arwShow">
								...
								<a href="" class="prev"><span class="hid">팝업존 이전</span><i class="xi-play" aria-hidden="true"></i></a>
								...
								<a href="" class="next"><span class="hid">팝업존 다음</span><i class="xi-play" aria-hidden="true"></i></a>
							</div>
						</div>
					...
					<div class="pop_schedule0021">
						...
						<div class="sche_wrap">
							<p class="month">
								...
								<a href="" class="prev"><span class="hid">이전달</span><i class="xi-play" aria-hidden="true"></i></a>
								<a href="" class="next"><span class="hid">다음달</span><i class="xi-play" aria-hidden="true"></i></a>
							</p>
							<div class="lst">
								<ul>
				...
				<div class="MC_box7">
					...
					<div class="meal_menu0021">
						...
						<img src="/images/template/${templateType}/main/0021_img_meal.png" alt="">
