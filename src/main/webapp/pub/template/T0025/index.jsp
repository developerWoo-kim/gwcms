...
<c:set var="templateType" value="T0025" />
...
<div id="wrap" class="openPop"> <!--[D] 팝업이 있을때 #wrap에 클래스 openPop 추가-->
	...
	<div id="container">
		...
		<div class="MC_wrap2 container">
			<div class="MC_box3">						
				<!-- 바로가기1 -->
				<div class="M_link0025">
					<ul>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0025_link01_01.png" alt=""></div>
								<p>교육목표</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0025_link01_02.png" alt=""></div>
								<p>유치원알리미</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0025_link01_03.png" alt=""></div>
								<p>통학버스</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0025_link01_04.png" alt=""></div>
								<p>사이버도서관사이버도서관사이버도서관</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0025_link01_05.png" alt=""></div>
								<p>정보공개</p>
							</a>
						</li>
						<li>
							<a href="">
								<div class="img"><img src="/images/template/${templateType}/main/0025_link01_06.png" alt=""></div>
								<p>학습자료실</p>
							</a>
						</li>
					</ul>
				...
				<div class="con_wrap">
						...
						<div class="notice0025">
							...
							<div class="tabWrap">
								<div class="list_box on" id="notice1">
									...
									<a href="" class="btn_more"><em class="hid">공지사항 더보기</em><i class="xi-plus-min"></i></a> 
								</div>
								...
								<div class="list_box" id="notice2">
									...
									<a href="" class="btn_more"><em class="hid">자유게시판 더보기</em><i class="xi-plus-min"></i></a> 
								</div>
								...
								<div class="list_box" id="notice3">
									...
									<a href="" class="btn_more"><em class="hid">게시판 더보기</em><i class="xi-plus-min"></i></a> 
								</div>
							</div>
						</div>
						<!-- //게시판1 -->
					...
					<div class="MC_box5">
						...
						<div class="meal_menu0025">
							...
							<div class="inner">
								<div class="inner_scroll">
									<ul tabindex="0">
										<li>
											<dl>
												<dt class="kcal"><span>점심 <em>984Kcal</em></span></dt>
												<dd class="meal_list">홍국쌀밥, 쇠고기미역국, 새송이호박볶음, 달걀야채말이, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기 </dd>
											</dl>
										</li>
										<li>
											<dl>
												<dt class="kcal"><span>저녁 <em>684 </em></span></dt>
												<dd class="meal_list">홍국쌀밥, 쇠고기미역국, 새송이호박볶음, 달걀야채말이, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기, 배추김치쇠고기 </dd>
											</dl>
										</li>
							...
							<img src="/images/template/${templateType}/main/0025_ico_meal.png" alt="">
							<a href="" class="btn_more"><em class="hid">오늘의 식단 더보기</em><i class="xi-plus-min"></i></a> 
						</div>
						<!-- //식단 -->
					</div>
					...
					<div class="gallery0025">
						...
						<div class="list_box">
							<ul>
								<li>
									<a href="">
										<p class="img"><img src="/images/template/T0025/main/0025_thumb_01.png" alt=""></p>
										<div class="tit">
								...
								<li>
									<a href="">
										<p class="img"><img src="/images/template/T0025/main/0025_thumb_02.png" alt=""></p>
										<div class="tit">
											<p>창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이</p>
										</div>
									</a>
								...
								<li>
									<a href="">
										<p class="img"><img src="/images/template/T0025/main/0025_thumb_03.png" alt=""></p>
										<div class="tit">
											<p>창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이</p>
										</div>
									</a>
						...
						<a href="" class="btn_more"><span class="hid">포토갤러리 더보기</span><i class="xi-plus-min" aria-hidden="true"></i></a>
					</div>
					<!-- //갤러리 -->
				</div>
			</div>
