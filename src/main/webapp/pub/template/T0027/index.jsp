...
<c:set var="templateType" value="T0027" />
	...
	<div id="container">
						...
						<div class="meal_menu0027">
							...
							<div class="inner">
								<ul tabindex="0">
									<li>
										<dl>
											<dt class="kcal"><span><strong>점심</strong><em><strong>984</strong>Kcal</em></span></dt>
							...
							<img src="/images/template/${templateType}/main/0027_ico_meal.png" alt="">
		...
		<div class="MC_wrap2">
			<div class="container">
				<div class="MC_box5">
					<!-- 바로가기1 -->
					<div class="M_link0027">
						<ul>
							<li>
								<a href="">
									<span class="img"><img src="/images/template/${templateType}/main/0027_link01_01.png" alt=""></span>
									<p>교육목표</p>
								</a>
							</li>
							<li>
								<a href="">
									<span class="img"><img src="/images/template/${templateType}/main/0027_link01_02.png" alt=""></span>
									<p>차량안내</p>
								</a>
							</li>
							<li>
								<a href="">
									<span class="img"><img src="/images/template/${templateType}/main/0027_link01_03.png" alt=""></span>
									<p>학습자료실학습자료실학습자료실학습자료실학습자료실학습자료실학습자료실학습자료실학습자료실</p>
								</a>
							</li>
							<li>
								<a href="">
									<span class="img"><img src="/images/template/${templateType}/main/0027_link01_04.png" alt=""></span>
									<p>사이버도서관</p>
								</a>
							</li>
							<li>
								<a href="">
									<span class="img"><img src="/images/template/${templateType}/main/0027_link01_05.png" alt=""></span>
									<p>유치원알리미</p>
								</a>
							</li>
						</ul>
						...
						<div class="list_box">
							<ul>
								<li>
									<a href="">
										<p class="img">
											<img src="/images/template/${templateType}/main/0027_thumb_01.png" alt="">
										</p>
										<p class="txt">
								...
								<li>
									<a href="">
										<p class="img">
											<img src="/images/template/${templateType}/main/0027_thumb_02.png" alt="">
										</p>
										<p class="txt">
											<strong>창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이</strong>
										</p>
								...
								<li>
									<a href="">
										<p class="img">
											<img src="/images/template/${templateType}/main/0027_thumb_03.png" alt="">
										</p>
										<p class="txt">
											<strong>창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이</strong>
										</p>
