...
<c:set var="templateType" value="T0031" />
	...
	<div id="container">
		...
		<div class="MC_wrap1">			
            <div class="container">
                <div class="MC_box1">
                    <!-- 메인비주얼 -->
                    <div class="MVisual0031 visual">
                        <div class="slider" id="visualSlide">
                            <p class="item"><img src="/images/template/${templateType}/main/m_visual.png" alt="꿈과 사랑을 키우는 행복한 학교"></p>
                            <p class="item"><img src="/images/template/${templateType}/main/m_visual.png" alt="꿈과 사랑을 키우는 행복한 학교"></p>
                        </div>
                        <div class="control">
                ...
                <div class="MC_box2">
                    <!-- 바로가기1 -->
                    <div class="M_link0031">
                        <ul>
                            <li><a href="">
                                <div class="img">
                                    <img src="/images/template/${templateType}/main/0031_link01_1.png" alt="">
                                </div> 
                                <p>교육과정 교육과정 교육과정</p>
                            </a></li>
                            <li><a href="">
                                <div class="img">
                                    <img src="/images/template/${templateType}/main/0031_link01_2.png" alt="">
                                </div> 
                                <p>학습과정</p>
                            </a></li>
                            <li><a href="">
                                <div class="img">
                                    <img src="/images/template/${templateType}/main/0031_link01_3.png" alt="">
                                </div> 
                                <p>운영위원회</p>
                            </a></li>
                            <li><a href="">
                                <div class="img">
                                    <img src="/images/template/${templateType}/main/0031_link01_4.png" alt="">
                                </div> 
                                <p>유치원알리미</p>
                            </a></li>
                        </ul>
		...
		<div class="MC_wrap2 container">
				...
				<div class="notice0031">
					...
					<div class="tabWrap">
						<div class="list_box on" id="notice1">
							...
							<a href="" class="btn_more"><span class="hid">공지사항</span><em>더보기</em><i class="xi-plus" aria-hidden="true"></i></a> 
						</div>
						<div class="list_box" id="notice2">
							...
							<a href="" class="btn_more"><span class="hid">가정통신문</span><em>더보기</em><i class="xi-plus" aria-hidden="true"></i></a> 
						</div>
						<div class="list_box" id="notice3">
							...
							<a href="" class="btn_more"><span class="hid">게시판</span><em>더보기</em><i class="xi-plus" aria-hidden="true"></i></a> 
						</div>
					</div>
				</div>
				<!-- //게시판 -->
            ...
            <div class="MC_box4">
				<!-- 갤러리 -->
				<div class="gallery0031">
					<h2 class="heading">포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리</h2>
					<div class="list_box">
						<ul>
							<li><a href="">
								<p class="img"><img src="/images/template/${templateType}/main/0031_thumb_01.png" alt=""></p>
								<p class="txt">
									창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이 창의력을 높이는 블럭놀이
								</p>
							</a></li>
							<li><a href="">
								<p class="img"><img src="/images/template/${templateType}/main/0031_thumb_02.png" alt=""></p>
								<p class="txt">
									창의력을 높이는 블럭놀이
								</p>
							</a></li> 
		...
		<div class="MC_wrap3 container">
			<div class="MC_box5">
				<!-- 캘린더 -->
				<div class="pop_schedule0031">
                    <div class="tit_wrap">
                        <h2 class="heading">월간일정</h2>
                    </div>
                    <div class="sche_wrap"> 
			...
			<div class="MC_box6">		
				<!-- 팝업존 -->
				<div class="pop0031 popupZone">
					<h2 class="heading">팝업존</h2>
					<div class="control arwShow">
						<p class="page"><strong></strong><span></span></p>
						<a href="" class="prev"><span class="hid">팝업존 이전</span></i></a>
			...
			<div class="MC_box7">						
				...
				<div class="meal_menu0031">
					...
					<img src="/images/template/${templateType}/main/0031_img_meal.png" alt="">
					<a href="" class="btn_more"><span class="hid">오늘의 식단</span><em>더보기</em><i class="xi-plus" aria-hidden="true"></i></a> 
				</div>
				<!-- //식단 -->
			</div>
		</div>
