...
<c:set var="templateType" value="T0041" />
...
<div id="wrap" class="openPop"> <!--[D] 팝업이 있을때 #wrap에 클래스 openPop 추가-->
	...
	<div id="container">
		...
		<div class="MC_wrap1 container">				
			<div class="MC_box1">
				<!-- 메인비주얼 -->
				<div class="MVisual0041 visual">
					<div class="slider" id="visualSlide">
						<p class="item"><img src="/images/template/${templateType}/main/m_visual.png" alt="슬기롭게 생각하며 마음껏 꿈을 펼치는 인재"></p>
						<p class="item"><img src="/images/template/${templateType}/main/m_visual.png" alt="슬기롭게 생각하며 마음껏 꿈을 펼치는 인재"></p>
					</div>
					<div class="control">
                ...
                <div class="pop_schedule0041"> 
                    ...
                    <div class="lst">  
                        <ul>
                            ...
                            <li><a href=""><span>02.09</span>소방안전교육의 날 소방안전교육의 날소방안전교육의 날 소방안전교육의 날소방안전교육의 날 소방안전교육의 날</a></li>
                    ...
                    <div class="sche_table">
                        <table>
                            <caption>캘린더 : 일, 월, 화, 수, 목, 금, 토</caption>
                            <colgroup>
            ...
            <div class="con_wrap">
                ...
                <div class="MC_box3">		
                    <!-- 팝업존 -->
                    <div class="pop0041 popupZone">
                        <h2 class="hid">팝업존</h2>
                        <div class="control arwShow">
                            <p class="page"><strong></strong><span></span></p>
                            <a href="" class="prev"><span class="hid">팝업존 이전</span><i class="xi-arrow-left" aria-hidden="true"></i></a>
                            <a href="" class="stop"><span class="hid">팝업존 정지</span><img src="/images/template/T0041/main/0041_pop_stop.png" alt="정지 버튼"></a>
                ...
                <div class="MC_box4">						
                    ...
                    <div class="meal_menu0041">
                        ...
                        <img src="/images/template/${templateType}/main/0041_img_meal.png" alt="">
            ...
            <div class="MC_box5">
                <!-- 바로가기1 -->
                <div class="M_link0041">
                    <ul>
                        <li><a href="">
                            <p>
                                <img src="/images/template/${templateType}/main/0041_link01_1.png" alt="">
                            </p> 
                            <span>교육과정 교육과정 교육과정</span>
                        </a></li>
                        <li><a href="">
                            <p>
                                <img src="/images/template/${templateType}/main/0041_link01_2.png" alt=""> 
                            </p>
                            <span>학습과정</span>
                        </a></li>
                        <li><a href="">
                            <p>
                                <img src="/images/template/${templateType}/main/0041_link01_3.png" alt=""> 
                            </p>
                            <span>운영위원회</span>
                        </a></li>
                        <li><a href="">
                            <p>
                              <img src="/images/template/${templateType}/main/0041_link01_4.png" alt=""> 
                            </p>
                            <span>유치원알리미</span>
                        </a></li>
                        <li><a href="">
                            <p>
                                <img src="/images/template/${templateType}/main/0041_link01_5.png" alt=""> 
                            </p>
                            <span>유치원알리미</span>
                        </a></li>
                        <li><a href="">
                            <p>
                                <img src="/images/template/${templateType}/main/0041_link01_6.png" alt=""> 
                            </p>
                            <span>유치원알리미</span>
                        </a></li>
                        <li><a href="">
                            <p>
                                <img src="/images/template/${templateType}/main/0041_link01_7.png" alt=""> 
                            </p>
                            <span>유치원알리미</span>
                        </a></li>
                        <li><a href="">
                            <p>
                                <img src="/images/template/${templateType}/main/0041_link01_8.png" alt=""> 
                            </p>
                            <span>유치원알리미</span>
                        </a></li>
                    </ul>
		...
		<div class="MC_wrap2 container">
					...
					<div class="tabWrap">
						<div class="list_box on" id="notice1">
							<ul>
								<li>
									<a href="" class="new">
										<p>공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항 공지사항공지사항공지사항</p>
							...
							<a href="" class="btn_more"><span class="hid">공지사항 더보기</span><i class="xi-arrow-right" aria-hidden="true"></i></a> 
						</div>
						<div class="list_box" id="notice2">
							<ul>
								<li>
									<a href="">
										<p>가정통신문 가정통신문 가정통신문 가정통신문 가정통신문 가정통신문 가정통신문 가정통신문 가정통신문 가정통신문 가정통신문 가정통신문 가정통신문 가정통신문</p>
										<span>2020-03-30</span>
									</a>
								</li>
								<li>
							...
							<a href="" class="btn_more"><span class="hid">가정통신문 더보기</span><i class="xi-arrow-right" aria-hidden="true"></i></a> 
						</div>
						<div class="list_box" id="notice3">
							<ul>
								<li>
									<a href="">
										<p>게시판 게시판 게시판 게시판 게시판 게시판 게시판 게시판 게시판 게시판 게시판 게시판 게시판 게시판 게시판 </p>
										<span>2020-03-30</span>
									</a>
								</li>
								<li>
							...
							<a href="" class="btn_more"><span class="hid">게시판 더보기</span><i class="xi-arrow-right" aria-hidden="true"></i></a> 
						</div>
					</div>
				</div>
				<!-- //게시판 -->
            ...
            <div class="MC_box7">
				<!-- 갤러리 -->
				<div class="gallery0041">
					<h2 class="heading">포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리포토갤러리</h2>
					<div class="list_box">
						<ul>
							<li><a href="">
								<p class="img"><img src="/images/template/${templateType}/main/0041_thumb_01.png" alt=""></p>
								<p class="txt">
							...
							<li><a href="">
								<p class="img"><img src="/images/template/${templateType}/main/0041_thumb_02.png" alt=""></p>
								<p class="txt">
									창의력을 높이는 블럭놀이
					...
					<a href="" class="btn_more" title="포토갤러리 더보기"><i class="xi-arrow-right" aria-hidden="true"></i></a>
				</div>
				<!-- //갤러리 -->
			</div>	 
		</div>
