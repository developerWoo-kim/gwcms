...
<c:set var="templateType" value="T0045" />
	...
	<div id="container">
								...
								<a href="" class="topList">
									<dl class="new"><!-- 새글 dl 'new' class 추가-->
										...
										<dd>
											...
											<div class="date"><span class="ico"><img src="/images/template/T0045/main/0045_ico_notice.png" alt=""></span>2022.04.20</div>
										</dd>
									</dl>
								</a>
								<ul>
							...
							<div class="list_box" id="notice2">
								<div href="" class="topList">
									...
									<dl class="no_data">
										...
										<dd>
											<p>데이터가 없습니다</p>
											<div class="date"><span class="ico"><img src="/images/template/T0045/main/0045_ico_notice.png" alt=""></span></div>
										</dd>
									</dl>
								</div>
							...
							<div class="list_box" id="notice3">
								<a href="" class="topList">
									<dl class="new"><!-- 새글 dl 'new' class 추가-->
										...
										<dd>
											<p>개인형 이동장치(PM) 관련 도로교통법 변경 사항을 안내합니다. 개인형 이동장치(PM) 관련 도로교통법 변경 사항을 안내합니다. 개인형 이동장치(PM) 관련 도로교통법 변경 사항을 안내합니다.</p>
											<div class="date"><span class="ico"><img src="/images/template/T0045/main/0045_ico_notice.png" alt=""></span>22-04-20</div>
										</dd>
									</dl>
								</a>
								<ul>
		...
		<div class="MC_wrap2">
			<div class="container">
				<div class="MC_box3">
					<!-- 바로가기1 -->
					<div class="M_link0045">
						<ul>
							<li><a href="">
								<div class="img">
									<img src="/images/template/${templateType}/main/0045_link01_1.png" alt="">
								</div>
								<p>교육과정 교육과정 교육과정</p>
							</a></li>
							<li><a href="">
								<div class="img">
									<img src="/images/template/${templateType}/main/0045_link01_2.png" alt="">
								</div>
								<p>학습과정</p>
							</a></li>
							<li><a href="">
								<div class="img">
									<img src="/images/template/${templateType}/main/0045_link01_3.png" alt="">
								</div>
								<p>운영위원회</p>
							</a></li>
							<li><a href="">
								<div class="img">
									<img src="/images/template/${templateType}/main/0045_link01_4.png" alt="">
								</div>
								<p>유치원알리미</p>
							</a></li>
							<li><a href="">
								<div class="img">
									<img src="/images/template/${templateType}/main/0045_link01_5.png" alt="">
								</div>
								<p>학부모서비스</p>
							</a></li>
							<li><a href="">
								<div class="img">
									<img src="/images/template/${templateType}/main/0045_link01_6.png" alt="">
								</div>
								<p>정보공개</p>
							</a></li>
							<li><a href="">
								<div class="img">
									<img src="/images/template/${templateType}/main/0045_link01_7.png" alt="">
								</div>
								<p>정보공개</p>
							</a></li>
						</ul>
				...
				<div class="MC_box4">
					...
					<div class="meal_menu0045">
						...
						<img src="/images/template/T0045/main/0045_img_meal.png" alt="">
					</div>
					<!-- //식단 -->
				</div>
				<div class="MC_box5">
					<!-- 갤러리 -->
					<div class="gallery0045">
						<div class="tit_wrap">
						...
						<div class="list_box">
							<ul>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0045_thumb_01.png" alt=""></p>
									<p class="txt">로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육</p>
								</a></li>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0045_thumb_02.png" alt=""></p>
									<p class="txt">로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육</p>
								</a></li> 
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0045_thumb_03.png" alt=""></p>
									<p class="txt">로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육로봇과 함께하는 스마트 교육</p>
								</a></li> 
		...
		<div class="MC_wrap3 container">
			<div class="MC_box6">
				...
				<div class="pop0045 popupZone">
					...
					<div class="pop_img" id="popupSlide">
						<p class="item"><a href="" title="새창" target="_blank"><img src="/images/template/${templateType}/main/img_popup01.png" alt="꿈이 자라고 행복과 사랑이 가득한 즐거운 배움터"></a></p>
						<p class="item"><a href="" title="새창" target="_blank"><img src="/images/template/${templateType}/main/img_popup01.png" alt="꿈이 자라고 행복과 사랑이 가득한 즐거운 배움터"></a></p>
					</div>
				</div>
				<!-- //팝업존 -->
			...
			<div class="MC_box7">						
				<!-- 캘린더 -->
				<div class="pop_schedule0045">
					<div class="lst">
						<h2 class="heading">행사일정</h2>
						<p class="month"><img src="/images/template/T0045/main/0045_ico_schedule.png" alt="">2022.<span>02</span>
						<a href="" class="prev"><span class="hid">이전달</span><i class="xi-caret-down" aria-hidden="true"></i></a>
						<a href="" class="next"><span class="hid">다음달</span><i class="xi-caret-up" aria-hidden="true"></i></a></p>
						...
						<a href="" class="btn_more"><em class="hid">행사일정 더보기</em><i class="xi-plus" aria-hidden="true"></i></a>
					</div>
					<div class="sche_wrap">
