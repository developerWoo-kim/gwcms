...
<c:set var="templateType" value="T0050" />
			...
			<div class="container">
					...
					<div class="notice0050">
						...
						<div class="tabWrap">
							...
							<div class="list_box" id="notice2">
								...
								<a href="" class="btn_more"><em class="hid">가정통신문 더보기</em></a> 
							</div>
				...
				<div class="MC_box3">						
					...
					<div class="meal_menu0050">
						...
						<span class="meal_bg_menu0050"><img src="/images/template/${templateType}/main/0050_img_meal.png" alt=""></span>
					</div>
					<!-- //식단 -->
				</div>	
				<div class="MC_box4">
					<!-- 캘린더 -->
					<div class="pop_schedule0050">
						<div class="tit_wrap">
							<h2>행사일정</h2>
							<p class="month">
				...
				<div class="MC_box5">						
					<!-- 바로가기1 -->
					<div class="M_link0050">
						<ul>
							<li>
								<a href="">
									<p><img src="/images/template/T0050/main/0050_ico01_link01.png" alt=""></p>
									<span>교육목표</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/T0050/main/0050_ico01_link02.png" alt=""></p>
									<span>방과후학교</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/T0050/main/0050_ico01_link03.png" alt=""></p>
									<span>사이버도서관</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/T0050/main/0050_ico01_link04.png" alt=""></p>
									<span>학습자료실</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/T0050/main/0050_ico01_link05.png" alt=""></p>
									<span>학교알리미</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/T0050/main/0050_ico01_link06.png" alt=""></p>
									<span>정보공개</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/T0050/main/0050_ico01_link07.png" alt=""></p>
									<span>운영위원회</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/T0050/main/0050_ico01_link08.png" alt=""></p>
									<span>각종양식</span>
								</a>
							</li>
						</ul>
					...
					<div class="pop0050 popupZone">
						<div class="tit_wrap">
							...
							<div class="nss_pg arwShow">
								...
								<a href="" class="play"><span class="hid">팝업존 재생</span></a>
				...
				<div class="MC_box7">
					...
					<div class="gallery0050">
						...
						<div class="list_box">
							<ul>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0050_thumb_02.png" alt=""></p>
									<p class="txt">즐거운 요리실습 즐거운 요리실습 즐거운 요리실습</p>
								</a></li>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0050_thumb_03.png" alt=""></p>
									<p class="txt">신기한 VR 체험 신기한 VR 체험 신기한 VR 체험 신기한 VR 체험</p>
								</a></li>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0050_thumb_01.png" alt=""></p>
									<p class="txt">안전한 등교길 안전한 등교길 안전한 등교길 안전한 등교길</p>
								</a></li>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0050_thumb_04.png" alt=""></p>
									<p class="txt">미래의 태권도 선수 미래의 태권도 선수 미래의 태권도 선수 미래의 태권도 선수</p>
								</a></li>
								<!-- 데이타가 없는경우 아래의 내용만 출력해주세요! -->
