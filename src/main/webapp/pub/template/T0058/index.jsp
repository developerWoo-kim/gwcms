...
<c:set var="templateType" value="T0058" />
			...
			<div class="MC_box2">
				...
				<div class="pop_schedule0058">
					...
					<div class="month">
						...
						<p><span>2022<em>02</em></span></p>
						<a href="" class="next"><span class="hid">다음달</span><i class="xi-caret-right" aria-hidden="true"></i></a>
					</div>
					<div class="sche_wrap">
						<ul class="lst">
							<li>
								<a href=""><span>03.01</span>어린이 교통사고 안전교육어린이 교통사고 안전교육어린이 교통사고 안전교육</a>
							</li>
							<li>
								<a href=""><span>03.08</span>어린이 교통사고 안전교육어린이 교통사고 안전교육어린이 교통사고 안전교육</a>
							</li>
							<li>
								<a href=""><span>03.11</span>어린이 교통사고 안전교육어린이 교통사고 안전교육어린이 교통사고 안전교육</a>
							</li>
							<li>
								<a href=""><span>03.28</span>어린이 교통사고 안전교육어린이 교통사고 안전교육어린이 교통사고 안전교육</a>
							</li>
							<li>
								<a href=""><span>03.28</span>어린이 교통사고 안전교육어린이 교통사고 안전교육어린이 교통사고 안전교육</a>
							</li>
				...
				<div class="notice0058">
					...
					<div class="tabWrap">
						<div class="list_box on" id="notice1">
							...
							<a href="" class="btn_more"><em class="hid">공지사항</em>more<i class="xi-plus" aria-hidden="true"></i></a>
						</div>
						<div class="list_box" id="notice2">
							...
							<a href="" class="btn_more"><em class="hid">가정통신문</em>more<i class="xi-plus" aria-hidden="true"></i></a>
						</div>
						<div class="list_box" id="notice3">
							...
							<a href="" class="btn_more"><em class="hid">게시판</em>more<i class="xi-plus" aria-hidden="true"></i></a>
						</div>
					</div>
				</div>
				<!-- //게시판 -->
			...
			<div class="MC_cont">
				<div class="MC_box4">
					...
					<div class="pop0058 popupZone">
						...
						<div class="control arwShow">
							...
							<a href="" class="stop"><span class="hid">팝업존 정지</span><img src="/images/template/T0058/main/0058_btn_popup_stop.png" alt=""></i></a>
				...
				<div class="MC_box5">
					...
					<div class="meal_menu0058">
						...
						<div class="img"><img src="/images/template/T0058/main/0058_bg_meal.png" alt=""></div>
				...
				<div class="MC_box6">
					<!-- 바로가기1 -->
					<div class="M_link0058">
						<ul>
							<li>
								<a href="">
									<p><img src="/images/template/${templateType}/main/0058_ico01_link01.png" alt=""></p>
									<span>방과후학교방과후학후학교</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/${templateType}/main/0058_ico01_link02.png" alt=""></p>
									<span>사이버도서관</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/${templateType}/main/0058_ico01_link03.png" alt=""></p>
									<span>학습자료실</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/${templateType}/main/0058_ico01_link04.png" alt=""></p>
									<span>학교알리미</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/${templateType}/main/0058_ico01_link05.png" alt=""></p>
									<span>각종양식</span>
								</a>
							</li>
							<li>
								<a href="">
									<p><img src="/images/template/${templateType}/main/0058_ico01_link06.png" alt=""></p>
									<span>교육목표</span>
								</a>
							</li>
						</ul>
				...
				<div class="MC_box7">
					<!-- 포토갤러리 -->
					<div class="gallery0058">
						<h2>포토갤러리</h2>
						<div class="list_box">
							<ul>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0058_thumb_01.png" alt=""></p>
									<span>책과 친해지는 즐거운 독서시간 책과 친해지는 즐거운 독서시간</span>
								</a></li>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0058_thumb_02.png" alt=""></p>
									<span>교내 겨울방학 창의융합교육</span>
								</a></li>
								<li><a href="">
									<p class="img"><img src="/images/template/${templateType}/main/0058_thumb_01.png" alt=""></p>
									<span>창의력이 쑥쑥!! 즐거운 미술시간</span>
								</a></li>
