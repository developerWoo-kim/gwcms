...
<c:set var="templateType" value="T0077" />
	...
	<div id="container">
		<div class="MC_wrap1"> 
			<div class="container"> 
				...
				<div class="MC_box2">		
					<!-- 팝업존 -->
					<div class="pop0077 popupZone">
						<h2 class="heading">팝업존</h2>  
						<div class="nss_pg">
							<p class="page"><strong></strong><span></span></p> 
							<a href="" class="prev"><i class="xi-long-arrow-left" aria-hidden="true"></i><em class="hid">팝업존 이전</em></a>
							...
							<a href="" class="next"><i class="xi-long-arrow-right" aria-hidden="true"></i><em class="hid">팝업존 다음</em></a>
						</div> 
					...
					<div class="notice0077"> 
						...
						<div class="tabWrap">
							<div class="list_box on" id="notice1"> 
								...
								<a href="" class="btn_more btnTy1">more</a> 
							</div>
			...
			<div class="container">  
				<div class="MC_box4">						
					...
					<div class="meal_menu0077">
						...
						<img src="/images/template/${templateType}/main/0077_img_meal.png" alt="">
						<a href="" class="btn_more btnTy2"><img src="/images/template/${templateType}/main/btn_plus01.png" alt="식단 더보기"></a> 
					</div>
					<!-- //식단 -->
				</div>
				<div class="MC_box5">
					<!-- 바로가기 -->
					<div class="M_link0077">
						<h2 class="hid">바로가기</h2>
						<ul>
							<li>
								<a href="">
									<span class="img"><img src="/images/template/${templateType}/main/0077_ico01_link01.png" alt=""></span>
									<p>교육목표</p>
								</a>
							</li>
							<li>
								<a href="">
									<span class="img"><img src="/images/template/${templateType}/main/0077_ico01_link02.png" alt=""></span>
									<p>방과후학교</p>
								</a>
							</li>
							<li>
								<a href="">
									<span class="img"><img src="/images/template/${templateType}/main/0077_ico01_link03.png" alt=""></span>
									<p>입학안내</p>
								</a>
							</li>
							<li>
								<a href="">
									<span class="img"><img src="/images/template/${templateType}/main/0077_ico01_link04.png" alt=""></span>
									<p>학습자료실</p>
								</a>
							</li> 
							<li>
								<a href="">
									<span class="img"><img src="/images/template/${templateType}/main/0077_ico01_link05.png" alt=""></span>
									<p>학교알리미</p>
								</a>
							</li>  
						</ul>
		...
		<div class="MC_wrap3">
			<div class="container"> 
				<div class="MC_box6">
					<!-- 갤러리 -->
					<div class="gallery0077">
						<h2 class="heading">포토갤러리</h2>
						<div class="list_box">
							<ul>
								<li><a href="">
									<div class="img"><img src="/images/template/${templateType}/main/0077_thumb_01.png" alt=""></div>
									<div class="txt">
										<p>1학년 방과후학교</p>
										<span class="date">2022-03-31</span>
										<em class="view">150</em>
									</div>
								</a></li>
								<li><a href="">
									<div class="img"><img src="/images/template/${templateType}/main/0077_thumb_02.png" alt=""></div>
									<div class="txt">
										<p>1~2학년 모의고사</p>
										<span class="date">2022-03-31</span>
										<em class="view">150</em>
								...
								<li><a href="">
									<div class="img"><img src="/images/template/${templateType}/main/0077_thumb_03.png" alt=""></div>
									<div class="txt">
										<p>고등학교 수학경시대회고등학교 수학경시대회고등학교 수학경시대회고등학교 수학경시대회</p>
										<span class="date">2022-03-31</span>
										<em class="view">150</em>
									</div>
								</a></li> 
				...
				<div class="MC_box7">
					<!-- 캘린더 -->
					<div class="pop_schedule0077">
						<h2 class="heading">행사일정</h2> 
						<div class="sche_wrap">
							<p class="month">
								<span class="date">2022년<em>02월</em></span>
								...
								<img src="/images/template/T0077/main/0077_img_noti.png" alt="">
							</p>  
							<div class="lst">
								<ul>
						...
						<a href="" class="btn_more btnTy2"><img src="/images/template/${templateType}/main/btn_plus02.png" alt="일정 더보기"></a> 
					</div>
					<!-- //캘린더 -->
				</div>
			</div>
