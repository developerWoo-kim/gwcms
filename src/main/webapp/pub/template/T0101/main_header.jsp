...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	...
	<!-- header--> 
	<header id="header" class="header0101">
		...
		<div class="topUtil">
			<ul class="util">
				<li><a href=""><i class="xi-home"></i>교육청</a></li>
				<li><a href=""><i class="xi-desktop"></i>전자도서관</a></li>
				<li><a href=""><i class="xi-log-in"></i>로그인</a></li>
				<!-- 로그인 상태일때 표출해주세요 -->
				<!-- <li><a href=""><i class="xi-log-out"></i>로그아웃</a></li> -->
				<!-- <li><a href=""><i class="xi-user-address"></i>마이페이지</a></li> -->
				<!-- //로그인 상태일때 표출해주세요 -->
				<li><a href=""><i class="xi-user"></i>회원가입</a></li>
				<li><a href=""><i class="xi-sitemap"></i>사이트맵</a></li>
			</ul>
