		...
		<div class="join_wrap"><!-- 로그인일 경우 join대신 login을 넣어서 넓잉값 조절할 것 -->
			 ...
			 <div class="mber_join_box">
				...
				<ol class="join_step">
					...
					<li class="on" title="현재단계"><div class="join_IcoBox"><span class="ico_joinStep"><img src="/00_common/images/member/img_joinStep3.png" alt="본인확인"></span></div><div><span class="point_col1">STEP</span> <span class="point_col2">03</span><br><strong>본인확인</strong></div></li>
				...
				<!-- 본인확인 -->
				<div class="join_txt">
					<h3 class="join_tit">사용자 인증</h3>
				</div>
				<div class="joinStep3">
					<p class="join_agre"><input type="checkbox" name="css_check" id="joinAgre"><label for="joinAgre" class="circle"></label><label for="joinAgre"><strong>법정대리인(보호자)</strong> 동의 <span class="ar_color">(필수)</span></label></p>
					<div class="joinStplat">
						<h5 class="StplatT1">제1장 총칙</h5>
						<dl class="StplatDl1">
							<dt>제1조 (목적)</dt>
							<dd>이 약관은 홈페이지가 제공하는 통합회원 서비스(이하 "서비스"라 합니다)를 이용함에 있어 이용자와 홈페이지간의 권리&middot;의무 및 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.</dd>

							<dt>제2조 (약관의 효력 및 변경)</dt>
							<dd>
								<ol>
									<li>① 이 약관은 서비스 화면에 게시하거나 기타의 방법으로 공지함으로써 이용자에게 공시하고, 이에 동의한 이용자가 서비스에 가입함으로써 효력이 발생합니다.</li>
									<li>② 홈페이지에서 필요하다고 인정되는 경우 이 약관의 내용을 변경할 수 있으며, 변경된 약관은 서비스 화면에 공지함으로써 이용자가 직접 확인할 수 있도록 할 것입니다.</li>
									...
									<li>④ 이용자가 이 약관의 내용에 동의하는 경우 홈페이지의의 서비스 제공행위 및 이용자의 서비스 이용행위에는 이 약관이 우선적으로 적용될 것입니다. 이 약관에 명시되지 않은 사항에 대해서는 전기통신기본법, 전기통신사업법, 정보통신망이용촉진및정보보호등에관한법률, 방송통신심의위원회 심의규정, 정보통신 윤리강령, 프로그램 보호법 등 기타 대한민국의 관련법령과 상관습에 의합니다.
										<ol>
											<li>1. 그외 기타 내용 들어갈 경우</li>
											<li>2. 그외 기타 내용 들어갈 경우
												<ul>
													<li>그외 기타 내용2</li>
													<li>그외 기타 내용2
														<ul>
				...
				<div class="selfChk_btn">
					<ul>
						<li class="selfChk_phone">
							<a href=""><span>휴대전화 본인인증</span></a>
						</li>
						<li class="selfChk_ipin">
							<a href=""><span>아이핀 본인인증</span></a>
						</li>
					</ul>
				</div>
				<!-- //본인확인 -->
